...
The `public contributions` and `private contributions` by users in Switzerland on `2026/3/2 1:02 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/gayanvoice/top-github-users).

There are `836 users`  in Switzerland. You need at least `104 followers` to be on this list.
