...
The `public contributions` and `private contributions` by users in Latvia on `2026/4/1 1:14 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.
